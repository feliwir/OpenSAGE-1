...
namespace OpenSage.Gui
{
    public sealed class DrawingContext2D : DisposableBase
    {
        ...
        public void DrawImage(Texture texture, in Rectangle? sourceRect, in Rectangle destinationRect, in bool flipped = false)
        {
        ...
        public void DrawImage(Texture texture, in Rectangle? sourceRect, in RectangleF destinationRect, in bool flipped = false)
        {
            var color = ColorRgbaF.White;
            color.A = _currentOpacity;
